...
export default function Services() {
  return (
    <section
      id="services"
      className="py-24 bg-neutral-900/50 border-y border-neutral-800/80"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-xs font-bold uppercase tracking-widest text-[#41B544]">
            Services Offered
          </h2>
          <p className="text-3xl font-bold tracking-tight text-white mt-2">
            Film Developing & Digital Scanning
          </p>
        </div>
