...
export default function StatsCard({
  ...
  return (
    <div>
      <h3 className="text-gray-900 dark:text-gray-400 font-medium text-sm uppercase tracking-wider">
        {label}
      </h3>
      <p className={`text-2xl font-bold mt-2 tracking-tight ${textColorClass}`}>
        {stat}
      </p>
      {stat2 && (
